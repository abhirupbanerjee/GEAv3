#!/bin/bash
# ============================================================================
# GEA Portal - AI Bots Table Migration
# ============================================================================
# Creates ai_bots table for managing AI chatbot inventory
# Run: ./database/scripts/15-create-ai-bots-table.sh
# ============================================================================
...
-- AI BOTS TABLE
-- ============================================================================
-- Stores AI chatbot inventory and configuration
...
-- Verify migration
SELECT
    'AI Bots Table Migration Complete' AS status,
    COUNT(*) AS total_bots,
...
echo ""
echo "✅ AI Bots table migration complete!"
echo ""
echo "Verify with:"
echo "  docker exec -it feedback_db psql -U feedback_user -d feedback -c 'SELECT id, name, status FROM ai_bots;'"
