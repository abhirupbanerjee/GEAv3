...
('GRV-2025-S001', 'SVC-IMM-001', 'DEPT-001', 'open', 'citizen',
 'Jane Doe', 'jane.doe@example.com', '+1-555-1001',
 'Sample Grievance Subject 1',
...
('GRV-2025-S002', 'SVC-TAX-001', 'DEPT-002', 'process', 'citizen',
 'John Smith', 'john.smith@example.com', '+1-555-1002',
 'Sample Grievance Subject 2',
 'Sample grievance description. This is test data for demonstration purposes only.',
 '2025-11-14', 'citizen_portal'),

('GRV-2025-S003', 'SVC-DIG-001', 'AGY-002', 'open', 'citizen',
 'Alice Brown', 'alice.brown@example.com', '+1-555-1003',
 'Sample Grievance Subject 3',
 'Sample grievance description. This is test data for demonstration purposes only.',
 '2025-11-16', 'citizen_portal'),

('GRV-2025-S004', 'SVC-REG-010', 'DEPT-004', 'resolved', 'citizen',
 'Bob Wilson', 'bob.wilson@example.com', '+1-555-1004',
 'Sample Grievance Subject 4',
 'Sample grievance description. This is test data for demonstration purposes only.',
...
('GRV-2025-S007', 'SVC-DIG-002', 'AGY-002', 'open', 'citizen',
 'Emily Johnson', 'emily.johnson@example.com', '+1-555-1007',
 'Sample Grievance Subject 7',
 'Sample grievance description. This is test data for demonstration purposes only.',
 '2025-11-18', 'citizen_portal'),

('GRV-2025-S008', 'SVC-IMM-001', 'DEPT-001', 'closed', 'citizen',
 'Frank Thompson', 'frank.thompson@example.com', '+1-555-1008',
 'Sample Grievance Subject 8',
 'Sample grievance description. This is test data for demonstration purposes only.',
...
('GRV-2025-S010', 'SVC-TAX-001', 'DEPT-002', 'resolved', 'citizen',
 'Henry Clark', 'henry.clark@example.com', '+1-555-1010',
 'Sample Grievance Subject 10',
 'Sample grievance description. This is test data for demonstration purposes only.',
...
('REQ-2025-001', 'digital-roadmap', 'DEPT-001', 'submitted',
 'Test User A', 'user.a@example.com', '+1-555-2001',
 'Sample Department A',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user'),

('REQ-2025-002', 'ea-framework-review', 'DEPT-002', 'process',
 'Test User B', 'user.b@example.com', '+1-555-2002',
 'Sample Department B',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user'),

('REQ-2025-003', 'maturity-assessment', 'DEPT-004', 'submitted',
 'Test User C', 'user.c@example.com', '+1-555-2003',
 'Sample Department C',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user'),

('REQ-2025-004', 'compliance-review', 'DEPT-001', 'process',
 'Test User D', 'user.d@example.com', '+1-555-2004',
 'Sample Department D',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user'),

('REQ-2025-005', 'portfolio-review', 'DEPT-002', 'submitted',
 'Test User E', 'user.e@example.com', '+1-555-2005',
 'Sample Department E',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user'),

('REQ-2025-006', 'training-capacity', 'AGY-002', 'resolved',
 'Test User F', 'user.f@example.com', '+1-555-2006',
 'Sample Agency F',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user'),

('REQ-2025-007', 'repository-access', 'DEPT-004', 'submitted',
 'Test User G', 'user.g@example.com', '+1-555-2007',
 'Sample Department G',
 'Sample EA service request. This is test data for demonstration purposes only.',
 'admin_user');
