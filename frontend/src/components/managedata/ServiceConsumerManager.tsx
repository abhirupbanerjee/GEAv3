...
import { FiEdit2, FiTrash2, FiSave, FiX, FiPlus, FiUsers } from 'react-icons/fi'
...
export default function ServiceConsumerManager() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add/Edit Form */}
      {showAddForm && (
        <form onSubmit={handleSubmit} className="bg-teal-50 border border-teal-200 rounded-lg p-6 space-y-4">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-lg font-semibold text-gray-900">
              {editingId ? 'Edit Service Consumer' : 'Add New Service Consumer'}
            </h3>
            <button
              type="button"
              onClick={resetForm}
          ...
          <div className="flex gap-2 pt-2">
            <button
              type="submit"
              className="px-6 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-lg flex items-center gap-2 transition-colors"
            >
